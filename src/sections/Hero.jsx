...
import { footerLinks, shoes, statistics } from "../constants";
    ...
    return(
        ...
        gap-10 max-container p-2">
            ...
            max-xl:padding-x pt-28">
                <p className="text-xl
                text-red-300">Our Summer Collection</p>
                <h1 className="mt-10 font-palanquin text-7xl 
                max-sm:text-[50px] font-bold">
                ...
                <p className="text-gray-500 text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort, and innovation
            ...
            xl:min-h-screen max-xl:py-40 bg-violet-100 bg-cover bg-center">
                <img
                    src={bigShoeImg}
                    alt="shoe collection"
                    width={450}
                ...
                sm:left-[10%] max-sm:px-6">
                    {shoes.map((shoe)=>(
                        <div key={shoe}>
                            <ShowCard
                            imgUrl={shoe}
                            changeBigShoeImg={(shoeImg)=>setBigShoeImg(shoeImg)}
